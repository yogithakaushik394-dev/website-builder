...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Yogitha Kaushik" },
      { name: "description", content: "A website builder that allows users to create and customize their own web pages with ease." },
      { property: "og:title", content: "Yogitha Kaushik" },
      { property: "og:description", content: "A website builder that allows users to create and customize their own web pages with ease." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "Yogitha Kaushik" },
      { name: "twitter:description", content: "A website builder that allows users to create and customize their own web pages with ease." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/B1dVWgYTFoP8vkfLFHyvrIGJkHr1/social-images/social-1779592012632-Serious_Headshot.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/B1dVWgYTFoP8vkfLFHyvrIGJkHr1/social-images/social-1779592012632-Serious_Headshot.webp" },
